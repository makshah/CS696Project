...
class BDCN_Fuzzy_SPL(nn.Module):
    def __init__(self, pretrain=None, logger=None, rate=4,image_size=200):
        super(BDCN_Fuzzy_SPL, self).__init__()
...
if __name__ == '__main__':
    model = BDCN_Fuzzy_SPL('./caffemodel2pytorch/vgg16.pth')
